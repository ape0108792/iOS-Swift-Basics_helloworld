...
class DataCenter {
    ...
    func defualtData() -> Array<Branch> {
        ...
        return [pangyoBranch, samsungBranch, yeoksamBranch, sinrimBranch, songdooBranch, anamBranch]
    }
}
