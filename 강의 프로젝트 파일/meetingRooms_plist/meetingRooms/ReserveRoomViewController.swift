...
class ReserveRoomViewController: UITableViewController {
    ...
    @IBAction func makeReservation(_ sender: Any) {
        ...
        case let tapbarC as UITabBarController:
            if let navigationC = tapbarC.selectedViewController as? UINavigationController, let reservationListVC = navigationC.topViewController as? ReservationListViewController {
